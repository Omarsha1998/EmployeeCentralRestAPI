...
router.get("/ws", (req, res) => {
  var wss = req.websocketConfig.wss;
...
router.post("/save-vas-booster-raw", (req, res) => {
  ...
  void (async function () {
    try {
      var sqlQuery = `exec HR..sp_RegisterVaccineHouseholdMemberAlumni
        '${req.body.category}',
        '${req.body.categoryID}',
        '${req.body.categoryIDNumber}',
...
router.post("/update-employee-vaccine-referring-info", (req, res) => {
  ...
  void (async function () {
    try {
      var sqlQuery = `exec HR..sp_UpdateUserVaccineMasterlistReferringInfo
              '${req.body.referringEmployeeID}',
              '${req.body.referringEmployeeName}',
...
router.post("/send-text-message-v2", (req, res) => {
  ...
  void (async function () {
    try {
      var sqlQuery = `insert into UERMSMS..Outbox
            (
              Msg,
              MPN,
              Status,
