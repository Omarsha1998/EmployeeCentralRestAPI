...
WHERE E.DeptCode LIKE @DeptCode AND
  ...
  const parameters = [
    { name: "DeptCode", dataType: "VarChar", value: `%${  body.department_code}` },
    { name: "PositionCode", dataType: "VarChar", value: `%${  body.position_code}` },
    { name: "Class", dataType: "VarChar", value: `%${  body.class_code}` },
    { name: "EmployeeStatus", dataType: "VarChar", value: `%${  body.status_code}` },
    { name: "Sex", dataType: "VarChar", value: `%${  body.gender_code}` },
    { name: "IsActive", dataType: "VarChar", value: `%${  body.active_code}` },
    { name: "LastName", dataType: "VarChar", value: `%${  body.last_name  }%` },
    { name: "FirstName", dataType: "VarChar", value: `%${  body.first_name  }%` },
    { name: "MiddleName", dataType: "VarChar", value: `%${  body.middle_name  }%` },
    { name: "Group", dataType: "VarChar", value: `%${  body.group_name}` },
    { name: "EmployeeCode", dataType: "VarChar", value: `%${  body.employee_code}` },
    { name: "EducationalAttainment", dataType: "VarChar", value: `%${  body.educational_attainment  }%` }
  ];
...
async function getPersonalInformations(employeeIDs, withLicenseCode) {
  ...
  for (let i = 0; i < employeeIDArray.length; i++) {
    ...
    inputParameters[`EmployeeID${i + 1}`] = "VarChar";
  }
