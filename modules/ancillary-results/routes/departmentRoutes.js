...
// POST REQUESTS
router.post("/", validateAccessToken, departmentController.insertDepartmentInfo);


// PUT REQUESTS 
router.put("/:code", validateAccessToken, departmentController.updateDepartmentInfo);
