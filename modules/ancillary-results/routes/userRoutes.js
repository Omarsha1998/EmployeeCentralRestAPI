...
router.post("/inauthenticate", validateAccessToken, userController.inauthenticate);
...
router.put("/roles/update/:code", validateAccessToken, userController.updateRole);
router.put("/reset-password/:code", validateAccessToken, userController.resetPassword);
