...
// GET REQUESTS
router.get("/nst-attendance/nst-census",  nursingStationController.getNSTCensusWithWard);
router.get("/nst-attendance/available-rooms-nurses",  nursingStationController.getAvailableRoomsAndDutyNurses);
